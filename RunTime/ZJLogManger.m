...
//把错误日志发送到邮箱
//    NSString *urlStr = [NSString stringWithFormat:@"mailto://302773170@qq.com?subject=bug报告&body=感谢您的配合!<br><br><br>错误详情:<br>%@",dateStr ];
 ...
 void UncaughtExceptionHandler(NSException* exception)
{
    ...
    //    //把错误日志发送到邮箱
//    NSString *urlStr = [NSString stringWithFormat:@"mailto://934111653@qq.com?subject=bug报告&body=感谢您的配合!<br><br><br>错误详情:<br>%@",crashString ];
//    NSURL *url = [NSURL URLWithString:[urlStr stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
//    [[UIApplication sharedApplication] openURL:url];
}
